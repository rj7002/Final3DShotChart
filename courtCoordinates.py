...
class CourtCoordinates:
    ...
    def __init__(self):
        ...
        self.hoop_radius = .75
        self.three_arc_distance = 23.75       # the NCAA men's three arc is 22ft and 1.75in from the center of the hoop
        self.three_straight_distance = 22      # the NCAA men's three straight section is 21ft 8in from the center of the hoop
